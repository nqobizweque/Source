...
namespace MySchedule.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoryID,Description,Abbreviation,Colour")] Category category)
        {

            if (!String.IsNullOrWhiteSpace(category.Description))
            {
                category.ApplicationUserID = User.Identity.GetUserName();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryID,ApplicationUserID,Description,Abbreviation,Colour")] Category category)
        {
